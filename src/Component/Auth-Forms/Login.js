    ...
    return (
        <form className='flex flex-col justify-center items-center gap-2 h-screen px-2 py-5'>
            ...
            <div className='flex flex-col lg:flex-row gap-2 justify-between lg:gap-3 w-5/6 sm:w-4/6 lg:w-1/2 text-sm  mt-14'>
                <button onClick={login} className='bg-btn-red text-white  p-3 font-semibold w-full xl:w-2/5 rounded-xl ' >Sign In</button>
                <button onClick={loginWithGoogle} className='bg-white text-black p-3 font-semibold w-full xl:w-2/5 rounded-xl' >Sign In with Google</button>
            </div>
